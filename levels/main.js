...
$("#submit").click(function startInterval() {
  if (clicked < 3) {
  clicked ++;
    interval = setInterval(generateWords, 1000);
  } else {
...
function generateWords () {
  var colors = ["#88EAF7", "#DD3737", "#A84198", "339355", "4147EA"];
  ...
  $('#box1').css("background-color", colors[rand1]);
  $('#box2').css("background-color", colors[rand2]);
  $('#box3').css("background-color", colors[rand3]);
  $('#box4').css("background-color", colors[rand4]);

  $('#box1').append('<h3 id="word1"></h3>');
  var word1 = words[Math.floor(Math.random()*words.length)];
  $("#word1").append(word1);
  paragraph = paragraph +  word1 + " ";

  $('#box2').append('<h3 id="word2"></h3>');
  var word2 = words[Math.floor(Math.random()*words.length)];
  $("#word2").append(word2);
  paragraph = paragraph +  word2 + " ";

  $('#box3').append('<h3 id="word3"></h3>');
  var word3 = words[Math.floor(Math.random()*words.length)];
  $("#word3").append(word3);
  paragraph = paragraph +  word3 + " ";
  

  $('#box4').append('<h3 id="word4"></h3>');
  var word4 = words[Math.floor(Math.random()*words.length)];
  $("#word4").append(word4);
  paragraph = paragraph +  word4 + " ";
...
$("#reset").click(function() {
  ...
  $('#box1').html('<h3 id="word1"></h3>');

  $('#box2').html('<h3 id="word2"></h3>');

  $('#box3').html('<h3 id="word3"></h3>');

  $('#box4').html('<h3 id="word4"></h3>');
